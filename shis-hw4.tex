...
\begin{answer}
With regular browser, it returns {\bf 403 Forbidden}.\\
With Tor browser, it shows {\bf the secret code is "sentientsheep"}
...
This script assume that tor is installed and added to PATH
\end{answer}
\medskip
