...
DEFAULT_RETRY = 5
COUNTRIES = [ 'US', 'GB', 'RU', 'DE', 'CA', 'NL', 'FR', 'AU', 'PL', 'CN', 'UA', 'IT', 'JP', 'IN', 'SE', 'ES', 'CH', 'RO', 'HK', 'AT', 'ID', 'CZ', 'SG', 'BE', 'NO', 'AR', 'DK', 'KR', 'FI', 'CL', 'TR', 'IR', 'NZ', 'BR', 'IE', 'ZA', 'BG', 'CO', 'PH', 'HU', 'MY', 'SI', 'TW', 'IL', 'TH', 'MX', 'BD', 'GR', 'PT', 'LV', 'SA', 'SK', 'NG', 'VN', 'PR', 'RS', 'PA', 'MD', 'LT', 'PK', 'VE', 'CR', 'HR', 'KZ', 'EC', 'LU', 'EE', 'HN', 'KE', 'MU', 'CY', 'EG', 'AE', 'PE', 'LB', 'BA', 'GT', 'GE', 'IQ', 'KW', 'KH', 'TZ', 'BY', 'AZ', 'AM', 'IS', 'PS', 'JO', 'GH', 'MT', 'SV', 'MK', 'AL', 'BO', 'DO', 'NI', 'NP', 'BB', 'AF', 'AO', 'AG', 'UZ', 'KG', 'MN', 'RE', 'SY', 'JM', 'BH', 'BZ', 'VG', 'PY', 'UG', 'MQ', 'LI', 'JE', 'LK', 'GP', 'ZM', 'MZ', 'DZ', 'SC', 'CW', 'CM', 'MA', 'VI', 'ZW', 'BM', 'UY', 'KN', 'TT', 'CD', 'ME', 'GA', 'OM', 'GU', 'BS', 'NA', 'QA', 'BW', 'NC', 'IM', 'PG', 'GF', 'VC', 'MW', 'LY', 'MO', 'GI', 'GD', 'GN', 'FJ', 'LC', 'KY', 'HT', 'DM', 'MG', 'SD', 'LS', 'CI', 'BN', 'LA', 'YE', 'TJ', 'MM', 'LR', 'VA', 'BJ', 'SZ', 'AW', 'CG', 'RW', 'BF', 'CU', 'MF', 'SO', 'MC', 'AI', 'BI', 'DJ', 'AS', 'VU', 'TN', 'SL', 'SN', 'NE', 'ML', 'WS', 'YT', 'SR', 'MR', 'MV', 'PF', 'SM', 'FO', 'GM', 'GY', 'TD', 'AX', 'SX', 'GG', 'BQ', 'BT', 'TC', 'SS', 'CV', 'MP', 'TL', 'TO', 'MS', 'SB', 'AD', 'GQ', 'CF', 'TM', 'BL', 'TG', 'NR', 'FM', 'GL', 'KP', 'MH', 'PM', 'GW', 'KM', 'FK', 'ET', 'PW', 'AQ', 'ST', 'XK', 'NF', 'WF', 'TV', 'KI', 'NU', 'TK', 'CC', 'CK', 'ER', 'TF', 'UM', 'IO', 'PN', 'SJ', 'GS', 'CX', 'SH']
